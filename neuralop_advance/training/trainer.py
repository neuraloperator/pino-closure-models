...
from neuralop.wcw import tool_wcw as wcw
...
class Trainer:
    ...
    def train(self, train_loader, test_loaders,
            optimizer, scheduler, regularizer,
              training_loss=None, eval_losses=None,losstype='sum'):
        ...
        for epoch in range(self.n_epochs):
            ...
            for idx, sample in enumerate(train_loader):###
                ...
                if self.amp_autocast:
                    ...
                    # if epoch<5 and idx<2:
                    #     wcw.ppp(epoch)
                    #     wcw.ppp(idx)
                    #     wcw.sss(sample['x'])
                    #     wcw.sss(sample['y'])
                    #     wcw.ppp(sample)
                    #     wcw.sss(self.model(**sample))
                    #     wcw.ppp(self.model(**sample))
            ...
            # wcw.ppp(train_err)
            # wcw.ppp(avg_loss)
            # wcw.ppp(len(train_loader))
            # wcw.ppp(self.n_epochs)

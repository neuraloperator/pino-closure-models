...
#
# x=torch.rand(4,4,32,120,120)
# y=domain_padding.pad(x)
# # z=domain_padding.pad(y)
# h=torch.rand(4,8,32,120,120)
# print(torch.equal(domain_padding.unpad(domain_padding.pad(h)),h))#true

...
def get_model(config,dvc=None):
    ...
    * some keyword arguments of the models aren't provided by the config
    ...
    '''New: add a input parameter. This modification is related to the new functionality of peak memory reduction.'''
    config_arch['dvc_cpt']=dvc if dvc is not None else 'cuda'

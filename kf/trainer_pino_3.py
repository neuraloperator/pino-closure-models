...
class Trainer:
    ...
    def train(self, train_loaders, test_loaders,
        ...
        """
        #add here
        use_loader=1  # loader in the outer loop
        use_loader_pde=1 # loader in the inner loop
        use_loader_128=2
        ...
        for epoch in range(self.n_epochs):
            ...
            for idx, sample in enumerate(train_loader):###
                ...
                if K128: #The number of frs data batches together with one pde data batch
                    if epoch<epoch_pde:
                        if idx>pre_pde_batch:
                            continue

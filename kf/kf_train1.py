...
from trainer_pino_kf1 import Trainer
...
pipe = ConfigPipeline(
    [
        YamlConfig(
            "./kf_pino.yaml", config_name="default", config_folder="../config"
        ),
...
if config.wandb.savemd:
    print('start save')
    torch.save({'model':model.state_dict()},f'model_save/KFmodel_cgs_{file_id}.pt')
    print('ok')
